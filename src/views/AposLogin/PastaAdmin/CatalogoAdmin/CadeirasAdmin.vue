            ...
            <div class="modal-content" style="background-color: #fefefe; margin: 15% auto; padding: 20px; border: 1px solid #888; width: 60%; border-radius: 10px;">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="tipo" v-model="novoCadeira.tipo" autocomplete="off">
                </div>
                <!-- Campo Material -->
                <div class="form-group">
      ...
      <tbody>
        <tr v-for="(item, index) in items" :key="index">
          ...
          <td class="TextAcoes">
            ...
            <button class="btn btn-danger btn-sm" @click="confirmDeleteCadeira(item.id)">
        ...
        <div class="modal-content" style="background-color: #fefefe; margin: 15% auto; padding: 20px; border: 1px solid #888; width: 60%; border-radius: 10px;">
          ...
          <div class="modal-body" >
            <form class="user-form">
              ...
              <div class="mb-3" style="font-family: Verdana;">
                <input type="text" class="form-control" placeholder="Novo Tipo" v-model="editedCadeira.tipo">
              </div>
              <div class="mb-3" style="font-family: Verdana;">
