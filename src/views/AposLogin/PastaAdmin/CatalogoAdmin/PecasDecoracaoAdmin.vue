            ...
            <div class="modal-content" style="background-color: #fefefe; margin: 15% auto; padding: 20px; border: 1px solid #888; width: 60%; border-radius: 10px;">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="tipo" v-model="novoPeca.tipo" autocomplete="off">
                </div>
                <!-- Campo Material -->
                <div class="form-group">
      ...
      <tbody>
        <tr v-for="(item, index) in items" :key="index">
          ...
          <td class="TextAcoes">
            ...
            <button class="btn btn-danger btn-sm" @click="confirmDeletePeca(item.id)">
        ...
        <div class="modal-content" style="background-color: #fefefe; margin: 15% auto; padding: 20px; border: 1px solid #888; width: 60%; border-radius: 10px;">
          ...
          <div class="modal-body" >
            <form class="user-form">
              ...
              <div class="mb-3" style="font-family: Verdana;">
                <input type="text" class="form-control" placeholder="Novo Tipo" v-model="editedPeca.tipo">
              </div>
              <div class="mb-3" style="font-family: Verdana;">
    ...
    confirmDeletePeca(pecaId) {
      ...
      if (confirmDelete) {
        axios.delete(`http://localhost:3000/PecasDecor/${pecaId}`)
          .then(response => {
            console.log("Peça eliminado com sucesso:", response.data);
            // Toastr de sucesso
            toastr.success("Peça eliminada com sucesso. (Reiniciando a página em 5 segundos)", "Sucesso", {
                closeButton: true,
                positionClass: "toast-bottom-right",
                progressBar: true,
                timeOut: 5000,
